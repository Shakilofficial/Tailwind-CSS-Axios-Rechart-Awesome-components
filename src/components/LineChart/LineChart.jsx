...
const LineChart = () => {
    ...
    return (
        <div className='space-y-6'>
            <h3 className='text-center text-blue-700 font-bold text-4xl'>Line Chart to Show the Data</h3>
            <LChart className='flex justify-center items-center' width={400} height={300} data={subjectMarksData}>
                <XAxis dataKey="name" />
                <YAxis></YAxis>
                <Line dataKey="math" stroke='red'></Line>
                <Line dataKey="physics" stroke='violet'></Line>
